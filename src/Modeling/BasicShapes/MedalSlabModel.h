...
namespace dyno
{
	...
	class MedalSlabModel : public BasicShape<TDataType>
	{
	...
	public:
		...
		std::string caption() override { return "Medal Slab"; }

		BasicShapeType getShapeType() override { return BasicShapeType::UNKNOWN; }
	...
	public:
		...
		static void pushback_medalslab(std::vector<Vec3f>& vertices, std::vector<TopologyModule::Triangle>& triangles, Vec3f pA, Vec3f pB, Vec3f pC, Real rA, Real rB, Real rC, uint resolution = 40);
	...
	IMPLEMENT_TCLASS(MedalSlabModel, TDataType);
}